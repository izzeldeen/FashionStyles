...
namespace FashionStyles.Areas.Customer.Controllers
{
    [Area("Customer")]
    public class HomeController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            IEnumerable<Product> productList = _unitOfWork.Product.GetAll(includeProperties: "Category,Store");
        ...
        public IActionResult Categorise()
        {
        ...
        {
            var productFromDb = _unitOfWork.Product.GetFirstOrDefault(u => u.Id == id, includeProperties: "Category,Store");
        ...
        public IActionResult Details(ShoppingCart CartObject)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (cartFromDb == null)
                {
                    //no records exists in database for that product 
            ...
            {
                var productFromDb = _unitOfWork.Product.GetFirstOrDefault(u => u.Id == CartObject.ProductId, includeProperties: "Category,Store");
                ShoppingCart cartobj = new ShoppingCart()
                {
                    Product = productFromDb,
                    ProductId = productFromDb.Id
